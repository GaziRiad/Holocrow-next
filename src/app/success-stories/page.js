...
function SuccessStories() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <section className="relative mb-12 sm:mb-24 md:-mb-32 xl:-mb-20">
        ...
        <section className="">
          ...
          >
            <Swiper
              ...
              className="storiesSlider w-[95%] absolute top-[40%] -translate-y-1/3 sm:top-[40%] md:top-[35%] lg:w-[80%] xl:top-[45%] xl:w-[65%] shadow-2xl rounded-2xl"
            >
                    ...
                    <div className="bg-white/50 h-screen flex flex-col items-center justify-center gap-2 px-6 py-8 lg:h-full xl:flex-row xl:p-10 2xl:p-20 2xl:gap-20">
                      <div className="xl:w-1/2 flex items-center justify-center">
                        <motion.img
                          ...
                          className=" w-1/2 h-auto xl:w-full rounded-2xl"
                        />
                      </div>
      ...
      <section className="mb-24 mt-40 lg:mt-20 flex flex-col items-center justify-center text-center">
