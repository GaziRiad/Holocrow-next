...
export default function Home() {
  const content = {
    ...
    statics: [
      ...
      { title: "CONNECTED CAMERAS", number: "+7500" },
      { title: "images generated", number: "2B Per min" },
    ],

    howItWorksSection: {
      heading: "How does Holocrow work?",
      patternImg: "../assets/homeimgs/how-it-work-pattern.png",
      steps: [
        {
          img: "../assets/homeimgs/how-it-work-main-1.png",
          text: {
        ...
        {
          img: "../assets/homeimgs/how-it-work-main-3.png",
          text: {
    ...
    platformDetails: {
      ...
      content: [
        {
          img: "../assets/homeimgs/platformOverView/Plug-Use and Alarms.png",
          title: "Plug & Use",
        ...
        {
          img: "../assets/homeimgs/platformOverView/Visual.png",
        ...
        {
          img: "../assets/homeimgs/platformOverView/Guides.png",
        ...
        {
          img: "../assets/homeimgs/platformOverView/helpdesk.png",
          title: "Helpdesk",
